namespace CrossroadsIO
{
    ...
    /// <summary>
    /// A single message-part to be sent or received via a <see cref="Socket"/>.
    /// </summary>
    /// <remarks>
    /// The <see cref="Frame"/> class has a one-to-one correspondence with the native <c>xs_msg_t</c> struct.
    /// </remarks>
