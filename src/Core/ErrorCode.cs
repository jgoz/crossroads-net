...
namespace CrossroadsIO
{
    ...
    public static class ErrorCode
    {
        ...
        [SuppressMessage("StyleCop.CSharp.NamingRules", "SA1310:FieldNamesMustNotContainUnderscore",
            Justification = "Mirrors constant defined in xs.h.")]
        public static readonly int XS_HAUS_NUMERO = 156384712;

        public static readonly int EFSM = XS_HAUS_NUMERO + 51;
        public static readonly int ENOCOMPATPROTO = XS_HAUS_NUMERO + 52;
        public static readonly int ETERM = XS_HAUS_NUMERO + 53;
        public static readonly int EMTHREAD = XS_HAUS_NUMERO + 54;
