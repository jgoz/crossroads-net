namespace CrossroadsIO.Devices
{
    ...
    public class DeviceSocketSetup
    {
        ...
        private readonly List<Action<Socket>> _socketInitializers;
        private readonly List<string> _bindings;
        private readonly List<string> _connections;

        private bool _isConfigured;

        internal DeviceSocketSetup(Socket socket)
        {
            if (socket == null)
            {
            ...
            _socket = socket;
            _socketInitializers = new List<Action<Socket>>();
            _bindings = new List<string>();
            _connections = new List<string>();
        }

        /// <summary>
        /// Configure the socket to bind to a given endpoint. See <see cref="Socket.Bind"/> for details.
        /// </summary>
        ...
        /// <summary>
        /// Configure the socket to connect to a given endpoint. See <see cref="Socket.Connect"/> for details.
        /// </summary>
        ...
        /// </summary>
        /// <param name="property">The <see cref="Socket"/> property to set.</param>
        /// <param name="value">The int value to assign.</param>
        /// <returns>The current <see cref="DeviceSocketSetup"/> object.</returns>
        public DeviceSocketSetup SetSocketOption(Expression<Func<Socket, int>> property, int value)
        {
        ...
        /// <returns>The current <see cref="DeviceSocketSetup"/> object.</returns>
        public DeviceSocketSetup SetSocketOption(Expression<Func<Socket, long>> property, long value)
        {
        ...
        /// <returns>The current <see cref="DeviceSocketSetup"/> object.</returns>
        public DeviceSocketSetup SetSocketOption(Expression<Func<Socket, ulong>> property, ulong value)
        {
        ...
        /// <returns>The current <see cref="DeviceSocketSetup"/> object.</returns>
        public DeviceSocketSetup SetSocketOption(Expression<Func<Socket, byte[]>> property, byte[] value)
        {
        ...
        /// <returns>The current <see cref="DeviceSocketSetup"/> object.</returns>
        public DeviceSocketSetup SetSocketOption(Expression<Func<Socket, TimeSpan>> property, TimeSpan value)
        {
            return SetSocketOption<TimeSpan>(property, value);
        }

        /// <summary>
        /// Configure the socket to subscribe to a specific prefix. See <see cref="Socket.Subscribe"/> for details.
        /// </summary>
        ...
        /// <summary>
        /// Configure the socket to subscribe to all incoming messages. See <see cref="Socket.SubscribeAll"/> for details.
        /// </summary>
        /// <returns>The current <see cref="DeviceSocketSetup"/> object.</returns>
        ...
        internal DeviceSocketSetup AddSocketInitializer(Action<Socket> setupMethod)
        {
        ...
        internal void Configure()
        {
            ...
            foreach (Action<Socket> initializer in _socketInitializers)
            {
        ...
        private DeviceSocketSetup SetSocketOption<T>(Expression<Func<Socket, T>> property, T value)
        {
            ...
            {
                throw new InvalidOperationException("The specified Socket member is not a property: " + property.Body);
            }
