namespace CrossroadsIO.Devices
{
    ...
    public abstract class Device : IDevice
    {
        ...
        /// A <see cref="Socket"/> that will pass incoming messages to <paramref name="backendSocket"/>.
        /// </param>
        /// <param name="backendSocket">
        /// A <see cref="Socket"/> that will receive messages from (and optionally send replies to) <paramref name="frontendSocket"/>.
        /// </param>
        /// <param name="mode">The <see cref="DeviceMode"/> for the current device.</param>
        protected Device(Socket frontendSocket, Socket backendSocket, DeviceMode mode)
        {
